...
var CubeComponent = /** @class */ (function () {
    ...
    CubeComponent.prototype.addAnimation = function (element) {
        var _this = this;
        var current_item = 0;
        var direction = -1;
        setInterval(function () {
            var len = _this.places.length - 1;
            if (-len == current_item) {
                direction = 1;
            }
...
var FormComponent = /** @class */ (function () {
    ...
    FormComponent.prototype.onSubmit = function (form) {
        ...
        if (form.valid) {
            this.apiService.post(form.value).subscribe(function (res) {
                _this.sent = true;
                _this.message = 'Send Succesfully, please await for the answer';
                // form.resetForm();
            }, function (err) {
                console.log(err.status);
                switch (err.status) {
                    case 400:
                        _this.message = "You already sent an email in the last hour, for spam prevention you can not use the Email: " + form.value.to + ", please message me at the following Email: majg8a@gmail.com, or use a different Email";
                        break;
                    case 500:
                        _this.message = "The Email: " + form.value.to + " is not valid please use another one";
                        break;
                }
            });
        }
...
var LevelCirclesComponent = /** @class */ (function () {
    function LevelCirclesComponent() {
        this.circles = ['circle', 'circle', 'circle', 'circle', 'circle'];
    }
    LevelCirclesComponent.prototype.ngOnInit = function () {
...
var PortafolioExample1Component = /** @class */ (function () {
    function PortafolioExample1Component() {
    }
    PortafolioExample1Component.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return PortafolioExample1Component;
}());
...
var ProfileCardComponent = /** @class */ (function () {
    ...
    ProfileCardComponent.prototype.change = function () {
        var _this = this;
        this.progresing = '';
        // progres start
        setTimeout(function () {
            if (_this.current_item == -2)
                _this.progresing = 'progresing';
        }, 500);
        // progres end
    ...
    ProfileCardComponent.prototype.addAnimationToContainer = function (direction) {
...
var MandatoryModule = /** @class */ (function () {
    function MandatoryModule() {
    }
